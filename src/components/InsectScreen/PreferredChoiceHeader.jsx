...
const PreferredChoiceHeader = () => {
  return (
    <section className="preferred-choice-section py-5">
      <div className="container text-center py-4">
        <div className="row justify-content-center">
          <div className="col-12 col-md-10 col-lg-8">

            <h6 className="choice-gold-badge text-uppercase mb-2">
              Quality You Trust
            </h6>

            <h2 className="choice-main-title mb-3">
              Why GHD Insect Screens Are <br className="d-none d-md-block" /> The Preferred Choice
            </h2>

            <p className="choice-subtext manrope-font mx-auto mb-0">
