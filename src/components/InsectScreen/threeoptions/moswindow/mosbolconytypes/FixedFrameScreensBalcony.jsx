...
const FixedFrameScreensBalcony = () => {
  return (
    <>
      {/* ================= HERO SECTION ================= */}
      <section 
      ...
      <section className="musquitotypes-gallery-section">
        <div className="container">
          ...
          <div className="musquitotypes-gallery-header text-center">
            <h2 className="musquitotypes-gallery-title font-serif stit">Fixed Frame Screens for Balcony</h2>
            <p className="musquitotypes-gallery-subtitle mx-auto hanken-grotesk-font sdes">
              Explore our complete range of premium Fixed Frame Net Balcony screens, specifically<br className="d-none d-md-block" /> 
          ...
          <div className="row g-4 musquitotypes-grid-row">
            ...
            <div className="col-12 col-lg-4">
              <div className="musquitotypes-img-container position-relative">
                <img src={img1} alt="Balcony Model 1" className="musquitotypes-grid-img" />
                <div className="musquitotypes-gallery-overlay-box">
                  <span className="musquitotypes-gold-badge fw-bolder manrope-font">MOSQUITO NET FOR BALCONY</span>
                  <h4 className="musquitotypes-hover-title font-serif">Fixed Frame Screen</h4>
                </div>
              </div>
            </div>
            ...
            <div className="col-12 col-lg-8">
              <div className="musquitotypes-img-container has-overlay-text position-relative">
                <img src={img2} alt="Balcony Model 2" className="musquitotypes-grid-img" />
            ...
            <div className="col-12 col-lg-8">
              <div className="musquitotypes-img-container has-overlay-text position-relative">
                <img src={img3} alt="Balcony Model 3" className="musquitotypes-grid-img" />
                <div className="musquitotypes-overlay-content">
            ...
            <div className="col-12 col-lg-4">
              <div className="musquitotypes-img-container position-relative">
                <img src={img4} alt="Balcony Model 4" className="musquitotypes-grid-img" />
                <div className="musquitotypes-gallery-overlay-box">
                  <span className="musquitotypes-gold-badge fw-bolder manrope-font">MOSQUITO NET FOR BALCONY</span>
                  <h4 className="musquitotypes-hover-title font-serif">Fixed Frame Screen</h4>
                </div>
        ...
        <div className="row musquitotypes-sticky-row">
          ...
          <div className="col-12 col-lg-6 musquitotypes-image-sticky-col">
            <div className="musquitotypes-sticky-image-card position-relative">
              <img 
                src={stickyImg} 
                alt="Balcony Net View 1" 
                className="musquitotypes-sticky-img" 
              />
              {/* Overlay Box with hover effect */}
              <div className="musquitotypes-gallery-overlay-box">
                <span className="musquitotypes-gold-badge manrope-font fw-bolder">MOSQUITO NET FOR BALCONY</span>
                <h4 className="musquitotypes-hover-title font-serif">Fixed Frame Screen</h4>
              </div>
            </div>
          </div>
          ...
          <div className="col-12 col-lg-6 musquitotypes-content-scroll-col">
            ...
            <div className="musquitotypes-right-img-card position-relative mb-5">
              <img src={rightImgTop} alt="Balcony Net View 2" className="musquitotypes-right-img" />
              <div className="musquitotypes-gallery-overlay-box">
                <span className="musquitotypes-gold-badge fw-bolder manrope-font">MOSQUITO NET FOR BALCONY</span>
                <h4 className="musquitotypes-hover-title font-serif">Modern Fixed Screens</h4>
              </div>
            </div>

            {/* Right Text Block 1 */}
            <div className="musquitotypes-text-block mb-5">
              <span className="musquitotypes-gold-badge manrope-font fw-bolder ssub">MOSQUITO NET FOR BALCONY</span>
              <h2 className="musquitotypes-main-heading mb-4 font-geist stit">
                Modern Fixed Frame <br className="d-none d-md-block" />Screen Solutions
              </h2>
              <p className=" musquitotypes-desc-text hanken-grotesk-font sdes">
                Whether you're looking to enjoy a breeze, gain clarity through unobstructed views, or simply find a few moments of calm in your busy day, these precision-engineered fixed screens will inspire and motivate.
              </p>
              <p className=" musquitotypes-desc-text hanken-grotesk-font sdes">
                Let our fixed frame mosquito nets be the companion that helps you navigate life's daily rhythms with grace and comfort.
              </p>
            </div>

            {/* Right Center Image with Hover Box */}
            <div className="musquitotypes-right-img-card position-relative mb-5">
              <img src={rightImgCenter} alt="Center Balcony Mosquito Net" className="musquitotypes-right-img" />
              <div className="musquitotypes-gallery-overlay-box">
                <span className="musquitotypes-gold-badge fw-bolder manrope-font">MOSQUITO NET FOR BALCONY</span>
            ...
            <div className="musquitotypes-text-block">
              ...
              <ul className="musquitotypes-features-list list-unstyled">
                ...
                <li className="d-flex align-items-start gap-3 mb-4">
                  <FaCheckCircle className="musquitotypes-tick-icon mt-1" />
                  <span className="hanken-grotesk-font sdes">Experts in solutions for Balcony screens</span>
                </li>
                <li className="d-flex align-items-start gap-3 mb-4">
                  <FaCheckCircle className="musquitotypes-tick-icon mt-1" />
...
export default FixedFrameScreensBalcony;