      ...
      <section className="musquitotypes-gallery-section">
        <div className="container">
          ...
          <div className="musquitotypes-gallery-header text-center">
            <h2 className="musquitotypes-gallery-title font-serif stit">All Mosquito Net Balcony</h2>
            <p className="musquitotypes-gallery-subtitle mx-auto hanken-grotesk-font sdes">
              Explore our complete range of premium Mosquito Net Balcony screens, specifically<br className="d-none d-md-block" /> 
            ...
            <div className="col-12 col-lg-4">
              <div className="musquitotypes-img-container position-relative">
                ...
                <div className="musquitotypes-gallery-overlay-box">
                  ...
                  <h4 className="musquitotypes-hover-title font-serif">Balcony Mosquito Screen</h4>
                </div>
              </div>
            </div>
        ...
        <div className="row musquitotypes-sticky-row">
          ...
          <div className="col-12 col-lg-6 musquitotypes-content-scroll-col">
            ...
            <div className="musquitotypes-right-img-card position-relative mb-5">
              ...
              <div className="musquitotypes-gallery-overlay-box">
                <span className="musquitotypes-gold-badge fw-bolder manrope-font">MOSQUITO NET FOR BALCONY</span>
                <h4 className="musquitotypes-hover-title font-serif">Modern Balcony Screens</h4>
              </div>
            </div>
            ...
            <div className="musquitotypes-text-block mb-5">
              ...
              <h2 className="musquitotypes-main-heading mb-4 font-geist stit">
                Modern Balcony <br className="d-none d-md-block" />Screen Solutions
              </h2>
              <p className=" musquitotypes-desc-text hanken-grotesk-font sdes">
                Whether you're looking to enjoy a breeze, gain clarity through unobstructed views, or simply find a few moments of calm in your busy day, these precision-engineered balcony screens will inspire and motivate.
              </p>
              <p className=" musquitotypes-desc-text hanken-grotesk-font sdes">
                Let our balcony mosquito nets be the companion that helps you navigate life's daily rhythms with grace and comfort.
              </p>
            </div>
...
export default AllMosquitoNetBalcony;