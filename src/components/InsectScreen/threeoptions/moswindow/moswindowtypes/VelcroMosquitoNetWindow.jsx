...
import storyhero from "../../../../../assets/Velcro Mosquito Net Window Banners (2).webp"
import img1 from '../../../../../assets/Velcro Mosquito Net Window Images (5).webp'; 
import img2 from '../../../../../assets/Velcro Mosquito Net Window Images (2).webp';
import img3 from '../../../../../assets/Velcro Mosquito Net Window Images (3).webp';
import img4 from '../../../../../assets/Velcro Mosquito Net Window Images (7).webp';

// Ningalude images ingane import cheyyuka
import stickyImg from '../../../../../assets/Velcro Mosquito Net Window Banners (2).webp'; // Left Sticky Image
import rightImgTop from '../../../../../assets/Velcro Mosquito Net Window Images (6).webp'; // Right Scrollable Image 1
import rightImgCenter from '../../../../../assets/Velcro Mosquito Net Window Images (8).webp';
import ExperienceAura from '../../../../Doors/SlideDoors/ExperienceAura';

const VelcroMosquitoNetWindow = () => {
  return (
    <>
      {/* ================= HERO SECTION ================= */}
      <section 
      ...
      <section className="musquitotypes-gallery-section">
        <div className="container">
          ...
          <div className="musquitotypes-gallery-header text-center">
            <h2 className="musquitotypes-gallery-title font-serif stit">Velcro Mosquito Net Window</h2>
            <p className="musquitotypes-gallery-subtitle mx-auto hanken-grotesk-font sdes">
              Explore our complete range of premium Velcro Mosquito Net Window, specifically<br className="d-none d-md-block" /> 
            ...
            <div className="col-12 col-lg-4">
              <div className="musquitotypes-img-container position-relative">
                ...
                <div className="musquitotypes-gallery-overlay-box">
                  ...
                  <h4 className="musquitotypes-hover-title font-serif">Velcro Mosquito Net Window</h4>
                </div>
              </div>
            </div>
        ...
        <div className="row musquitotypes-sticky-row">
          ...
          <div className="col-12 col-lg-6 musquitotypes-content-scroll-col">
            ...
            <div className="musquitotypes-right-img-card position-relative mb-5">
              <img src={rightImgTop} alt="Velcro Net View 2" className="musquitotypes-right-img" />
              <div className="musquitotypes-gallery-overlay-box">
                <span className="musquitotypes-gold-badge fw-bolder manrope-font">MOSQUITO NET FOR WINDOW</span>
                <h4 className="musquitotypes-hover-title font-serif">Modern Velcro Screens</h4>
              </div>
            </div>
            ...
            <div className="musquitotypes-text-block mb-5">
              ...
              <h2 className="musquitotypes-main-heading mb-4 font-geist stit">
                Modern Velcro <br className="d-none d-md-block" />Window Screens
              </h2>
              <p className=" musquitotypes-desc-text hanken-grotesk-font sdes">
                Whether you're looking to enjoy a breeze, gain clarity through unobstructed views, or simply find a few moments of calm in your busy day, these precision-engineered velcro screens will inspire and motivate
              </p>
              <p className=" musquitotypes-desc-text hanken-grotesk-font sdes">
                Let our velcro mosquito nets be the companion that helps you navigate life's daily rhythms with grace and comfort
              </p>
            </div>

            {/* Right Center Image with Hover Box */}
            <div className="musquitotypes-right-img-card position-relative mb-5">
              <img src={rightImgCenter} alt="Center Velcro Mosquito Net" className="musquitotypes-right-img" />
              <div className="musquitotypes-gallery-overlay-box">
                <span className="musquitotypes-gold-badge fw-bolder manrope-font">MOSQUITO NET FOR WINDOW</span>
            ...
            <div className="musquitotypes-text-block">
              ...
              <ul className="musquitotypes-features-list list-unstyled">
                ...
                <li className="d-flex align-items-start gap-3 mb-4">
                  <FaCheckCircle className="musquitotypes-tick-icon mt-1" />
                  <span className="hanken-grotesk-font sdes">Experts in solutions for Casement, Velcro screens</span>
                </li>
                <li className="d-flex align-items-start gap-3 mb-4">
                  <FaCheckCircle className="musquitotypes-tick-icon mt-1" />
...
export default VelcroMosquitoNetWindow;