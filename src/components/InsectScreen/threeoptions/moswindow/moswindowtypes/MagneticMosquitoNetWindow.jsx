...
import storyhero from "../../../../../assets/Magnetic Mosquito Net Window Banner.webp"
import img1 from '../../../../../assets/Magnetic Mosquito Net Window Images (1).webp'; 
import img2 from '../../../../../assets/Magnetic Mosquito Net Window Images (5).webp';
import img3 from '../../../../../assets/Magnetic Mosquito Net Window Images (8).webp';
import img4 from '../../../../../assets/Magnetic Mosquito Net Window Images (4).webp';

// Ningalude images ingane import cheyyuka
import stickyImg from '../../../../../assets/Magnetic Mosquito Net Window Images (5).webp'; // Left Sticky Image
import rightImgTop from '../../../../../assets/Magnetic Mosquito Net Window Images (6).webp'; // Right Scrollable Image 1
import rightImgCenter from '../../../../../assets/Magnetic Mosquito Net Window Images (1).webp'; // Right Scrollable Image 2
import ExperienceAura from '../../../../Doors/SlideDoors/ExperienceAura';

const MagneticMosquitoNetWindow = () => {
  return (
    <>
      {/* ================= HERO SECTION ================= */}
      <section 
      ...
      <section className="musquitotypes-gallery-section">
        <div className="container">
          ...
          <div className="musquitotypes-gallery-header text-center">
            <h2 className="musquitotypes-gallery-title font-serif stit">Magnetic Mosquito Net Window</h2>
            <p className="musquitotypes-gallery-subtitle mx-auto hanken-grotesk-font sdes">
              Explore our complete range of premium Magnetic Mosquito Net Window, specifically<br className="d-none d-md-block" /> 
            ...
            <div className="col-12 col-lg-4">
              <div className="musquitotypes-img-container position-relative">
                ...
                <div className="musquitotypes-gallery-overlay-box">
                  ...
                  <h4 className="musquitotypes-hover-title font-serif">Magnetic Mosquito Net Window</h4>
                </div>
              </div>
            </div>
          ...
          <div className="col-12 col-lg-6 musquitotypes-content-scroll-col">
            ...
            <div className="musquitotypes-text-block mb-5">
              ...
              <h2 className="musquitotypes-main-heading mb-4 font-geist stit">
                Modern Magnetic <br className="d-none d-md-block" />Window Screens
              </h2>
...
export default MagneticMosquitoNetWindow;