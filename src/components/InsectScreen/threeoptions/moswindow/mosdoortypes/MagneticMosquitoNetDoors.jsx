...
const MagneticMosquitoNetDoors = () => {
  return (
    <>
      {/* ================= HERO SECTION ================= */}
      <section 
      ...
      <section className="musquitotypes-gallery-section">
        <div className="container">
          ...
          <div className="musquitotypes-gallery-header text-center">
            <h2 className="musquitotypes-gallery-title font-serif stit">Magnetic Mosquito Net Doors</h2>
            <p className="musquitotypes-gallery-subtitle mx-auto hanken-grotesk-font sdes">
              Explore our complete range of premium Magnetic Mosquito Net Doors, specifically<br className="d-none d-md-block" /> 
            ...
            <div className="col-12 col-lg-4">
              <div className="musquitotypes-img-container position-relative">
                ...
                <div className="musquitotypes-gallery-overlay-box">
                  ...
                  <h4 className="musquitotypes-hover-title font-serif">Magnetic Mosquito Net Door</h4>
                </div>
              </div>
            </div>
        ...
        <div className="row musquitotypes-sticky-row">
          ...
          <div className="col-12 col-lg-6 musquitotypes-content-scroll-col">
            ...
            <div className="musquitotypes-right-img-card position-relative mb-5">
              <img src={rightImgTop} alt="Magnetic Net View 2" className="musquitotypes-right-img" />
              <div className="musquitotypes-gallery-overlay-box">
                <span className="musquitotypes-gold-badge fw-bolder manrope-font">MOSQUITO NET FOR DOORS</span>
                <h4 className="musquitotypes-hover-title font-serif">Modern Magnetic Screens</h4>
              </div>
            </div>
            ...
            <div className="musquitotypes-text-block mb-5">
              ...
              <h2 className="musquitotypes-main-heading mb-4 font-geist stit">
                Modern Magnetic <br className="d-none d-md-block" />Door Screens
              </h2>
              <p className=" musquitotypes-desc-text hanken-grotesk-font sdes">
                Whether you're looking to enjoy a breeze, gain clarity through unobstructed views, or simply find a few moments of calm in your busy day, these precision-engineered magnetic screens will inspire and motivate.
              </p>
              <p className=" musquitotypes-desc-text hanken-grotesk-font sdes">
                Let our magnetic mosquito nets be the companion that helps you navigate life's daily rhythms with grace and comfort.
              </p>
            </div>

            {/* Right Center Image with Hover Box */}
            <div className="musquitotypes-right-img-card position-relative mb-5">
              <img src={rightImgCenter} alt="Center Magnetic Mosquito Net" className="musquitotypes-right-img" />
              <div className="musquitotypes-gallery-overlay-box">
                <span className="musquitotypes-gold-badge fw-bolder manrope-font">MOSQUITO NET FOR DOORS</span>
            ...
            <div className="musquitotypes-text-block">
              ...
              <ul className="musquitotypes-features-list list-unstyled">
                ...
                <li className="d-flex align-items-start gap-3 mb-4">
                  <FaCheckCircle className="musquitotypes-tick-icon mt-1" />
                  <span className="hanken-grotesk-font sdes">Experts in solutions for Casement, Magnetic doors</span>
                </li>
                <li className="d-flex align-items-start gap-3 mb-4">
                  <FaCheckCircle className="musquitotypes-tick-icon mt-1" />
...
export default MagneticMosquitoNetDoors;