...
import storyhero from "../../../../../assets/pleaded8.webp"
...
import stickyImg from '../../../../../assets/sliding5.webp'; // Left Sticky Image
import rightImgTop from '../../../../../assets/sliding6.webp'; // Right Scrollable Image 1
import rightImgCenter from '../../../../../assets/sliding7.webp'; // Right Scrollable Image 2
import ExperienceAura from '../../../../Doors/SlideDoors/ExperienceAura';

const AllMosquitoNetDoors = () => {
  return (
    <>
      {/* ================= HERO SECTION ================= */}
      <section 
      ...
      <section className="musquitotypes-gallery-section">
        <div className="container">
          ...
          <div className="musquitotypes-gallery-header text-center">
            <h2 className="musquitotypes-gallery-title font-serif stit">All Mosquito Net Doors</h2>
            <p className="musquitotypes-gallery-subtitle mx-auto hanken-grotesk-font sdes">
              Explore our complete range of premium Mosquito Net Doors, specifically<br className="d-none d-md-block" /> 
          ...
          <div className="row g-4 musquitotypes-grid-row">
            ...
            <div className="col-12 col-lg-4">
              <div className="musquitotypes-img-container position-relative">
                ...
                <div className="musquitotypes-gallery-overlay-box">
                  <span className="musquitotypes-gold-badge manrope-font">MOSQUITO NET FOR DOORS</span>
                  <h4 className="musquitotypes-hover-title font-serif">Premium Door Screen</h4>
                </div>
              </div>
            </div>
            ...
            <div className="col-12 col-lg-4">
              <div className="musquitotypes-img-container position-relative">
                ...
                <div className="musquitotypes-gallery-overlay-box">
                  <span className="musquitotypes-gold-badge manrope-font">MOSQUITO NET FOR DOORS</span>
                  <h4 className="musquitotypes-hover-title font-serif">Durable Door Screen</h4>
                </div>
              </div>
            </div>
        ...
        <div className="row musquitotypes-sticky-row">
          ...
          <div className="col-12 col-lg-6 musquitotypes-image-sticky-col">
            <div className="musquitotypes-sticky-image-card position-relative">
              ...
              <div className="musquitotypes-gallery-overlay-box">
                <span className="musquitotypes-gold-badge manrope-font ">MOSQUITO NET FOR DOORS</span>
                <h4 className="musquitotypes-hover-title font-serif">All Mosquito Net Doors</h4>
              </div>
            </div>
          </div>
          ...
          <div className="col-12 col-lg-6 musquitotypes-content-scroll-col">
            ...
            <div className="musquitotypes-right-img-card position-relative mb-5">
              <img src={rightImgTop} alt="Door Net View 2" className="musquitotypes-right-img" />
              <div className="musquitotypes-gallery-overlay-box">
                <span className="musquitotypes-gold-badge manrope-font">MOSQUITO NET FOR DOORS</span>
                <h4 className="musquitotypes-hover-title font-serif">Modern Door Screens</h4>
              </div>
            </div>

            {/* Right Text Block 1 */}
            <div className="musquitotypes-text-block mb-5">
              <span className="musquitotypes-gold-badge manrope-font ssub">MOSQUITO NET FOR DOORS</span>
              <h2 className="musquitotypes-main-heading mb-4 font-geist stit">
                Modern Mosquito <br className="d-none d-md-block" />Door Screens
              </h2>
              <p className=" musquitotypes-desc-text hanken-grotesk-font sdes">
                Whether you're looking to enjoy a breeze, gain clarity through unobstructed views, or simply find a few moments of calm in your busy day, these precision-engineered door screens will inspire and motivate.
              </p>
              <p className=" musquitotypes-desc-text hanken-grotesk-font sdes">
                Let our mosquito net doors be the companion that helps you navigate life's daily rhythms with grace and comfort.
              </p>
            </div>

            {/* Right Center Image with Hover Box */}
            <div className="musquitotypes-right-img-card position-relative mb-5">
              <img src={rightImgCenter} alt="Center Door Mosquito Net" className="musquitotypes-right-img" />
              <div className="musquitotypes-gallery-overlay-box">
                <span className="musquitotypes-gold-badge manrope-font">MOSQUITO NET FOR DOORS</span>
...
export default AllMosquitoNetDoors;