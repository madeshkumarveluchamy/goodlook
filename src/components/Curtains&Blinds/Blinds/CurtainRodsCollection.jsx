  ...
  return (
    <section className="rods-collection-section ">
      <div className="container py-4 text-center">
        ...
        <h2 className="rods-main-title mb-2 font-serief">Window Blinds</h2>
        <h2 className="rods-main-title mb-4">Collections</h2>
        
        <p className="rods-sub-desc manrope-font mx-auto mb-5">
        ...
        <div className="current-rods-heading text-center text-md-start mb-4 font-serief">
              ...
              <div className="row align-items-center  text-center text-md-start g-4 w-100 m-0">
                <div className="col-12 col-md-8 text-center text-md-start p-0">
                  <h4 className="overlay-rods-title mb-2 text-center text-md-start font-serief">
                    <span className="bullet-diamond-small ">❖</span> Window Blinds
                  </h4>
                  <p className="overlay-rods-desc text-center text-md-start manrope-font mb-0 hanken-grotesk-font">
