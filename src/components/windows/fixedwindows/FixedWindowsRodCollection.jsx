...
const FixedWindowsRodCollection = () => {
  return (
    <section className="fixedwindows-rod-collection-section">
      <div className="container py-4 text-center">
        ...
        <div className="fixedwindows-rod-display-window">
          <div className="fixedwindows-rod-showcase-card">
            <img 
              src={rodImg} 
              alt="Premium Curtain rod Designs collections" 
              className="fixedwindows-rod-main-img"
            />

            <div className="fixedwindows-rod-glass-card-overlay">
              <div className="row align-items-center text-center text-md-start g-4 m-0">
                ...
                <div className="col-12 col-md-4 text-md-end p-0 pb-3 pt-md-0">
                  <Link to="/contact-us" className="text-decoration-none">
                    <button className="btn btn-light fixedwindows-project-cta-capsule-btn d-inline-flex align-items-center gap-2">
                      <span className="manrope-font btn-text">Start Your Project</span>
                      <span className="fixedwindows-yellow-arrow-circle d-flex align-items-center justify-content-center">
        ...
        <div className="fixedwindows-features-exact-wrapper mt-5 pt-3 text-start">
...
export default FixedWindowsRodCollection;