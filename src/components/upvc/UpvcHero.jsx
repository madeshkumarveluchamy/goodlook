...
import curtainsHeroBg from '../../assets/upvcframe1.webp';
        ...
        <div className="row h-100 align-items-center">
          ...
          <div className="col-12 curtains-hero-text-engine text-center text-lg-start">
            <h1 className="curtains-hero-massive-title m-0 inter-font fw-semibold select-none">
              <span className="curtains-title-row-white text-white d-block">Explore Our Premium</span>
              <span className="curtains-title-row-cream d-block">uPVC Collection Here</span>
            </h1>
          </div>
