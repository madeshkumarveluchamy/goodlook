...
import featImg1 from '../../assets/upvc1.png'; 
import featImg2 from '../../assets/upvc2.png'; 
import featImg3 from '../../assets/upvc3.png'; 
import featImg4 from '../../assets/upvc4.png'; 
import featImg6 from '../../assets/upvc5.png'; 
import featImg7 from '../../assets/upvc6.png'; 
        ...
        <div className="features-main-flex-wrapper">
          ...
          <div className="features-layout-row row-type-top mb-5">
            ...
            <div className="feature-item-card top-hero-card text-center text-md-start">
              <span className="card-serial-number inter-font d-block text-center text-md-start manrope-font">01.</span>
          ...
          <div className="features-layout-row row-type-middle mb-5">
            ...
            <div className="feature-item-card middle-slim-card text-center text-md-start">
              <span className="card-serial-number d-block text-center text-md-start manrope-font">02.</span>
              <div className="feature-card-img-wrapper horizontal-narrow-frame mx-auto mx-md-0">
            ...
            {/* CARD 03 */}
            <div className="feature-item-card middle-slim-card text-center text-md-start">
              <span className="card-serial-number inter-font d-block text-center text-md-start manrope-font">03.</span>
              <div className="feature-card-img-wrapper horizontal-narrow-frame mx-auto mx-md-0">
                <img src={featImg3} alt="High Light Transmittance" className="w-100 h-100 object-fit-cover" />
              </div>
              <h4 className="feature-card-title mt-3 mb-2 inter-font text-center text-md-start manrope-font sdes">High Light Transmittance</h4>
              <p className="feature-card-desc m-0 hanken-grotesk-font text-center text-md-start hanken-grotesk-font sdes">
            ...
            {/* CARD 04 */}
            <div className="feature-item-card middle-slim-card text-center text-md-start">
              <span className="card-serial-number inter-font d-block text-center text-md-start manrope-font">04.</span>
              <div className="feature-card-img-wrapper horizontal-narrow-frame mx-auto mx-md-0">
          ...
          <div className="features-layout-row row-type-bottom">
            ...
            <div className="feature-item-card bottom-centered-card text-center text-md-start">
              <span className="card-serial-number inter-font d-block text-center text-md-start manrope-font">05.</span>
              {/* FIXED: Uniform narrow profile height frame added */}
              <div className="feature-card-img-wrapper horizontal-narrow-frame mx-auto mx-md-0">
            ...
            {/* CARD 06 */}
            <div className="feature-item-card bottom-centered-card text-center text-md-start">
              <span className="card-serial-number inter-font d-block text-center text-md-start manrope-font ">06.</span>
              {/* FIXED: Uniform narrow profile height frame added */}
              <div className="feature-card-img-wrapper horizontal-narrow-frame mx-auto mx-md-0">
