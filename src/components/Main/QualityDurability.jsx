          ...
          <div className="col-12 col-md-8">
            <div className="bento-card large-white-card p-4 p-sm-5 d-flex flex-column justify-content-between h-100">
              <div className="card-top-content">
                ...
                <h3 className="bento-card-title font-sans fw-bold mb-3 hanken-grotesk-font text-center text-md-start">25-Year Integrity Warranty</h3>
          ...
          <div className="col-12 col-md-4">
            <div className="bento-card dark-solid-card p-4 p-sm-5 d-flex flex-column justify-content-between h-100">
              <div className="card-top-content">
                ...
                <h3 className="dark-card-title font-serif text-white mb-4 text-center text-md-start stit">Sustainably <br />Sourced Materials</h3>
        ...
        <div className="row g-4 bento-lower-row">
          ...
          <div className="col-12 col-md-4">
            <div className="utility-minimal-card p-4 text-center d-flex flex-column align-items-center justify-content-center">
              ...
              <h5 className="util-card-heading fw-semibold mb-2 manrope-font ssub">Artisan Built</h5>
              <p className="util-card-desc m-0 text-muted fw-light hanken-grotesk-font sdes">Each piece is hand-finished by master craftspeople.</p>
            </div>
          </div>
          ...
          <div className="col-12 col-md-4">
            <div className="utility-minimal-card p-4 text-center d-flex flex-column align-items-center justify-content-center">
              ...
              <h5 className="util-card-heading fw-semibold mb-2 manrope-font ssub">Pristine Textiles</h5>
              <p className="util-card-desc m-0 text-muted fw-light hanken-grotesk-font sdes">Grade-A leathers and high-thread-count linens.</p>
            </div>
          </div>
          ...
          <div className="col-12 col-md-4">
            <div className="utility-minimal-card p-4 text-center d-flex flex-column align-items-center justify-content-center">
              ...
              <h5 className="util-card-heading fw-semibold mb-2 manrope-font ssub">Timeless Design</h5>
              <p className="util-card-desc m-0 text-muted fw-light hanken-grotesk-font sdes">Shapes designed to transcend seasonal trends.</p>
            </div>
          </div>
